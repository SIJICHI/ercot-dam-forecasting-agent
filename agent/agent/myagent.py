...
def graph_factory(
    ...
    agent_forecaster = create_agent(
        ...
        system_prompt=make_system_prompt(
            ...
            "- get_dataset_details: Retrieve details about a DataRobot dataset by dataset_id\n"
            "- get_deployment_features: Retrieve feature information for a DataRobot deployment by deployment_id\n"
            "- predict_realtime: Execute real-time prediction using a DataRobot deployment.\n"
            "  Call predict_realtime with dataset_id, deployment_id, and the forecast time range.\n"
            "\n"
            "Steps to follow:\n"
            "1. Call get_dataset_details with the dataset_id to confirm the dataset is accessible.\n"
            "2. Call predict_realtime with the dataset_id, deployment_id, forecast_range_start, "
            "and forecast_range_end to obtain the 24-hour price predictions.\n"
            "3. Return the raw prediction results (timestamps and predicted DAM prices) to the next agent.\n"
            "\n"
